...
def main():
    ...
    parser.add_argument('--num-labeled', type=int, default=80,   #134  80  28
                        help='number of labeled data New=8')
    parser.add_argument('--total-steps', default=20000, type=int, # 68000  80000  56000
                        help='number of total steps to run 2**20')
    parser.add_argument('--eval-step', default=40, type=int,  # 34  40  14
                        help='number of eval steps to run 768')
    parser.add_argument('--batch-size', default=2, type=int,  #4  2  2
                        help='train batchsize')
    parser.add_argument('--mu', default=2.5, type=float,   #1  2.5  4
   ...
   #----------------------------------------------------------------------------
    ...
    #datapath = ['./dataset/ECA9A/Train']
    #test_datapath = ['./dataset/ECA9A/Test']
    #weak_augmenta_datapath = ['./dataset/ECA9A/Train']
    #strong_augmenta_datapath = ['./dataset/ECA9A/Train']
