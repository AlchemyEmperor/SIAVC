...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv_s2t = nn.Conv3d(512, 2048, kernel_size=1, stride=1, padding=0)

        self.conv1_3d = nn.Conv3d(n_input_channels,
                               self.in_planes,
                               kernel_size=(conv1_t_size, 7, 7),
                               stride=(conv1_t_stride, 2, 2),
                               padding=(conv1_t_size // 2, 3, 3),
                               bias=False)
        self.bn3d = nn.BatchNorm3d(self.in_planes)
        ...
        # -----------------------------------------
        self.fc = nn.Linear(512, n_classes)   # Resnet50  2048

        self.top_bn_layer = nn.BatchNorm1d(n_classes)
    ...
    def get_feat_modules(self):
        ...
        feat_m.append(self.conv1_3d)
        feat_m.append(self.bn3d)
        feat_m.append(self.relu_3d)
        feat_m.append(self.layer1_3d)
        feat_m.append(self.layer2_3d)
        feat_m.append(self.layer3_3d)
        feat_m.append(self.layer4_3d)
    ...
    def forward(self, x, is_feat=False):
        ...
        if is_feat:
            return [f0, f1, f2, f3, f4, f5], out, cls
        else:
            return out, cls
