...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Conv3d(n_input_channels,
                               ...
                               bias=False)
        self.bn1_3d = nn.BatchNorm3d(self.in_planes)
        ...
        # classifer branch
        # self.change_dim = convert()
        channels = [16, 16 * widen_factor2, 32 * widen_factor2, 64 * widen_factor2, 2048, 4096]
        # ------------------------FixMatch part----------------------------------
    ...
    def forward(self, x):
        ...
        # # feature = x  # for adanet branch
        # out = self.fc(x)  # out (2,2)
        # out = F.softmax(out, 1)
        #
        ...
        # discriminator branch   原来的代码用下面那个
